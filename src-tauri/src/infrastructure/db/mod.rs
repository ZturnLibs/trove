...
const MIGRATIONS: &[(i64, &str)] = &[
    ...
    (17, include_str!("../../../migrations/0017_automation.sql")),
    (18, include_str!("../../../migrations/0018_import_batches.sql")),
    (
        19,
    ...
    (
        21,
        include_str!("../../../migrations/0021_semantic_index.sql"),
    ),
];
...
mod tests {
    ...
    fn migrates_and_reports_health() {
        ...
        assert_eq!(health.schema_version, 21);
    ...
    fn migrate_is_idempotent() {
        ...
        db.migrate(None).unwrap();
        assert_eq!(db.health_check().unwrap().schema_version, 21);
    }
